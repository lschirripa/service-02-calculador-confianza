...
from models.models import Comunidad, UsuarioOutput, Incidente, Usuario, ComunidadOutput
...
class CalculatorService:
    ...
    def calcular_confianza(self, comunidad: Comunidad):
        ...
        armado_output = ComunidadOutput(usuarios_output=output_usuarios,
                                        nivel_de_confianza=round(confianza_comunidad, 2))
    ...
    def calcular_nivel_de_confianza_y_recomendacion(self, puntajeFinal):
        if puntajeFinal < 2:
            ...
            return "Confiable nivel 2", "un pana"
